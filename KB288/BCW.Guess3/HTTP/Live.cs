...
namespace TPR3.Http
{
    ...
    public class GetLive
    {
        ...
        /// 取得足球即时比分列表
        /// </summary>
        public TPR3.Model.Http.Live Getzlist(string p_title, int kind)
        {
            TPR3.Model.Http.Live objzlist = null;
        ...
        private TPR3.Model.Http.Live LivezlistHtml(string p_html)
        {
            string strVal = p_html;
            TPR3.Model.Http.Live objzlist = new TPR3.Model.Http.Live();
        ...
        /// 取得未开/进行/完场列表
        /// </summary>
        public TPR3.Model.Http.Live Getmlist(string p_title, int State, int kind)
        {
            TPR3.Model.Http.Live objmlist = null;
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR3.Model.Http.Live LivemlistHtml(string p_html)
        {
            string strVal = p_html;
            TPR3.Model.Http.Live objmlist = new TPR3.Model.Http.Live();
        ...
        /// 取得详细记录
        /// </summary>
        public TPR3.Model.Http.Live Getvlist(int kind, int SClassID, string SClass)
        {
            TPR3.Model.Http.Live objvlist = null;
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR3.Model.Http.Live LivevlistHtml(string p_html)
        {
            string strVal = p_html;
            TPR3.Model.Http.Live objvlist = new TPR3.Model.Http.Live();
