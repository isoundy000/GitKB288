...
namespace TPR.Http
{
    ...
    public class GetLive4
    {
        ...
        /// 取得篮球完场比分/一周赛事
        /// </summary>
        public TPR.Model.Http.Live4 Getllist2(string p_title, int itype)
        {
            TPR.Model.Http.Live4 objllist2 = null;
        ...
        private TPR.Model.Http.Live4 Livellist2Html(string p_html, int itype)
        {
            string strVal = p_html;
            TPR.Model.Http.Live4 objllist2 = new TPR.Model.Http.Live4();
        ...
        /// 取得篮球完场比分/一周赛事子列表
        /// </summary>
        public TPR.Model.Http.Live4 Getllists2(string p_day, int itype)
        {
            TPR.Model.Http.Live4 objllists2 = null;
            string url = "";
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR.Model.Http.Live4 Livellists2Html(string p_html, int itype)
        {
            string strVal = p_html;
            TPR.Model.Http.Live4 objllists2 = new TPR.Model.Http.Live4();
        ...
        /// 取得详细记录
        /// </summary>
        public TPR.Model.Http.Live4 GetView(string p_day, int itype, int SClassID, string SClass)
        {
            TPR.Model.Http.Live4 objview = null;
            string url = "";
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR.Model.Http.Live4 LiveViewHtml(string p_html)
        {
            string strVal = p_html;
            TPR.Model.Http.Live4 objview = new TPR.Model.Http.Live4();
