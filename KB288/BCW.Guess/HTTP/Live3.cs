...
namespace TPR.Http
{
    ...
    public class GetLive3
    {
        ...
        /// 取得篮球即时比分列表
        /// </summary>
        public TPR.Model.Http.Live3 Getllist(string p_title)
        {
            TPR.Model.Http.Live3 objllist = null;
        ...
        private TPR.Model.Http.Live3 Live3llistHtml(string p_html)
        {
            string strVal = p_html;
            TPR.Model.Http.Live3 objllist = new TPR.Model.Http.Live3();
        ...
        /// 取得今天篮球全部赛事
        /// </summary>
        public TPR.Model.Http.Live3 Gettlist(string p_title)
        {
            TPR.Model.Http.Live3 objtlist = null;
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR.Model.Http.Live3 Live3tlistHtml(string p_html)
        {
            string strVal = p_html;
            TPR.Model.Http.Live3 objtlist = new TPR.Model.Http.Live3();
        ...
        /// 取得详细记录
        /// </summary>
        public TPR.Model.Http.Live3 Getvlist(int SClassID, string SClass)
        {
            TPR.Model.Http.Live3 objvlist = null;
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR.Model.Http.Live3 Live3vlistHtml(string p_html)
        {
            string strVal = p_html;
            TPR.Model.Http.Live3 objvlist = new TPR.Model.Http.Live3();
