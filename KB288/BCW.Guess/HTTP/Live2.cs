...
namespace TPR.Http
{
    ...
    public class GetLive2
    {
        ...
        /// 取得足球完场比分/一周赛事
        /// </summary>
        public TPR.Model.Http.Live2 Getzlist2(string p_title, int itype)
        {
            TPR.Model.Http.Live2 objzlist2 = null;
        ...
        private TPR.Model.Http.Live2 Livezlist2Html(string p_html, int itype)
        {
            string strVal = p_html;
            TPR.Model.Http.Live2 objzlist2 = new TPR.Model.Http.Live2();
        ...
        /// 取得足球完场比分/一周赛事子列表
        /// </summary>
        public TPR.Model.Http.Live2 Getzlists2(string p_day, int itype)
        {
            TPR.Model.Http.Live2 objzlists2 = null;
            string url = "";
            if (itype == 1)
            {
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR.Model.Http.Live2 Livezlists2Html(string p_html)
        {
            string strVal = p_html;
            TPR.Model.Http.Live2 objzlists2 = new TPR.Model.Http.Live2();
        ...
        /// 取得详细记录
        /// </summary>
        public TPR.Model.Http.Live2 GetView(string p_day, int act,int SClassID)
        {
            TPR.Model.Http.Live2 objview = null;
            string url = "";
            if (act == 8)
            {
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR.Model.Http.Live2 LiveViewHtml(string p_html)
        {
            string strVal = p_html;
            TPR.Model.Http.Live2 objview = new TPR.Model.Http.Live2();
