...
namespace TPR.DAL.guess
{
    ...
    public class BaPay
    {
        ...
        public bool Exists(int bcid, int payusid)
        {
            ...
            strSql.Append("select count(1) from tb_BaPay");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT p_getMoney from tb_BaPay where ");
            strSql.Append(" id=@id ");
            strSql.Append(" and payusid=@payusid ");
            strSql.Append(" and itypes=@itypes ");
            strSql.Append(" and p_active>@p_active ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT Count(ID) from tb_BaPay where ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT sum(payCent) from tb_BaPay where ");
            strSql.Append("bcid=@bcid and ");
            strSql.Append("pType=@pType and ");
            strSql.Append("itypes=@itypes and Types=0 ");
            SqlParameter[] parameters = {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT Count(ID) from tb_BaPay where " + strWhere + " and itypes=0");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT sum(payCent) from tb_BaPay where " + strWhere + " and itypes=0");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT sum(p_getMoney) from tb_BaPay where " + strWhere + " and itypes=0");
        ...
        public void Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_BaPay ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public decimal Getp_getMoney(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 p_getMoney from tb_BaPay ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public int GetTypes(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Types from tb_BaPay ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        {
            IList<TPR.Model.guess.BaPay> listBaPayViews = new List<TPR.Model.guess.BaPay>();
            ...
            if (itype == 0)
            {
                queryString = "SELECT payusid,payusname,count(payusid) as payCount,sum(payCent) as payCents FROM tb_BaPay where " + strWhere + " group by payusid,payusname Order by sum(payCent) desc";
            }
            else
            {
                queryString = "SELECT payusid,payusname,sum(p_getMoney) as payCount,sum(payCent) as payCents FROM tb_BaPay where " + strWhere + " group by payusid,payusname Order by (sum(p_getMoney)-sum(payCent)) desc";
            }
