...
namespace TPR3.Collec
{
    ...
    public class Foot
    {
        ...
        private IList<TPR3.Model.guess.BaList> FootHtml(string p_xml, out int p_recordCount)
        {
            IList<TPR3.Model.guess.BaList> listFoots = new List<TPR3.Model.guess.BaList>();
            p_recordCount = 0;
            try
            {
        ...
        /// 取得足球大小盘XML
        /// </summary>
        public IList<TPR3.Model.guess.BaList> GetFootdx(out int p_recordCount)
        {
            IList<TPR3.Model.guess.BaList> obj = new List<TPR3.Model.guess.BaList>();
            p_recordCount = 0;
        ...
        /// 取得足球标准盘XML
        /// </summary>
        public IList<TPR3.Model.guess.BaList> GetFootbz(out int p_recordCount)
        {
            IList<TPR3.Model.guess.BaList> obj = new List<TPR3.Model.guess.BaList>();
            p_recordCount = 0;
        ...
        private static string getLostone(string uid)
        {
