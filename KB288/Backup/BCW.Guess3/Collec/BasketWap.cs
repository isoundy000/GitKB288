...
namespace TPR3.Collec
{
    ...
    public class BasketWap
    {
        ...
        private string BasketWapHtml(string p_html)
        {
            ...
            //string strpattern = @"<table width=""100%"" border=""0"" bgcolor=""#FFFFFF"">([\s\S]+?)\s资料库</u>";
            //Match mtitle = Regex.Match(p_html, strpattern, RegexOptions.Compiled | RegexOptions.IgnoreCase);
            //if (mtitle.Success)
            //{
            //    return "#" + mtitle.Groups[1].Value;
            //}
            //else
            //{
            //    return "";
