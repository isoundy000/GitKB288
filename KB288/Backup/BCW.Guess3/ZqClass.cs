...
namespace TPR3.Common.Guess
{
    ...
    public class ZqClass
    {
        ...
        /// <returns></returns>
        public static string getZqsxCase(TPR3.Model.guess.BaPay model)
        {
            string strVal = "";
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static string getZqdxCase(TPR3.Model.guess.BaPay model)
        {
            string strVal = "";
            int intone, inttwo;
            intone = Convert.ToInt32(model.p_result_one);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static string getZqbzCase(TPR3.Model.guess.BaPay model)
        {
            string strVal = "";
            int intone, inttwo;
            intone = Convert.ToInt32(model.p_result_one);
        ...
        public static string getZqdsCase(TPR3.Model.guess.BaPay model)
        {
            string strVal = "";
            int intone, inttwo;
            intone = Convert.ToInt32(model.p_result_one);
