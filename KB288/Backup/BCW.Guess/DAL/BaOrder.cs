...
namespace TPR.DAL.guess
{
	...
	public class BaOrder
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(TPR.Model.guess.BaOrder model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_BaOrder(");
		...
		/// 更新一条数据
		/// </summary>
		public void Update(TPR.Model.guess.BaOrder model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tb_BaOrder set ");
        ...
        public void DeleteStr()
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_BaOrder ");
        ...
        {
            IList<TPR.Model.guess.BaOrder> listBaOrders = new List<TPR.Model.guess.BaOrder>();

            string sTable = "tb_BaOrder";
            string sPkey = "id";
