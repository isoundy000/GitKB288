...
namespace TPR.Collec
{
    ...
    public class Foot
    {
        ...
        /// 取得足球让球盘XML
        /// </summary>
        public IList<TPR.Model.guess.BaList> GetFoot(out int p_recordCount)
        {
        ...
        /// 取得足球大小盘XML
        /// </summary>
        public IList<TPR.Model.guess.BaList> GetFootdx(out int p_recordCount)
        {
            IList<TPR.Model.guess.BaList> obj = new List<TPR.Model.guess.BaList>();
            p_recordCount = 0;
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private IList<TPR.Model.guess.BaList> FootdxHtml(string p_xml, out int p_recordCount)
        {
            IList<TPR.Model.guess.BaList> listFootdxs = new List<TPR.Model.guess.BaList>();
            p_recordCount = 0;
            try
            {
                using (XmlReaderExtend reader = new XmlReaderExtend(p_xml))
        ...
        /// 取得足球标准盘XML
        /// </summary>
        public IList<TPR.Model.guess.BaList> GetFootbz(out int p_recordCount)
        {
            IList<TPR.Model.guess.BaList> obj = new List<TPR.Model.guess.BaList>();
            p_recordCount = 0;
