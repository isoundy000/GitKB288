...
namespace LHC.DAL
{
    ...
    public class VoteNo
    {
        ...
        public int GetMaxId()
        {
            return SqlHelper.GetMaxID("ID", "tb_VoteNo");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from tb_VoteNo");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into tb_VoteNo(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_VoteNo set ");
        ...
        public void Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_VoteNo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public int GetqiNo(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 qiNo from tb_VoteNo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public int GetpayCount(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 payCount from tb_VoteNo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public LHC.Model.VoteNo GetVoteNo(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,qiNo,ExTime,payCent,payCount,payCent2,payCount2,sNum,pNum1,pNum2,pNum3,pNum4,pNum5,pNum6,State,AddTime from tb_VoteNo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;

            LHC.Model.VoteNo model = new LHC.Model.VoteNo();
            using (SqlDataReader reader = SqlHelper.ExecuteReader(strSql.ToString(), parameters))
            {
                if (reader.HasRows)
                {
        ...
        {
            IList<LHC.Model.VoteNo> listVoteNos = new List<LHC.Model.VoteNo>();
            string sTable = "tb_VoteNo";
            string sPkey = "id";
            ...
            using (SqlDataReader reader = SqlHelper.RunProcedureMe(sTable, sPkey, sField, p_pageIndex, p_pageSize, sCondition, sOrder, iSCounts, out p_recordCount))
            {
                ...
                while (reader.Read())
                {
                    LHC.Model.VoteNo objVoteNo = new LHC.Model.VoteNo();
                    objVoteNo.ID = reader.GetInt32(0);
                    objVoteNo.qiNo = reader.GetInt32(1);
                    objVoteNo.ExTime = reader.GetDateTime(2);
                    objVoteNo.payCent = reader.GetInt64(3);
                    objVoteNo.payCount = reader.GetInt32(4);
                    objVoteNo.sNum = reader.GetInt32(5);
                    objVoteNo.pNum1 = reader.GetInt32(6);
                    objVoteNo.pNum2 = reader.GetInt32(7);
                    objVoteNo.pNum3 = reader.GetInt32(8);
                    objVoteNo.pNum4 = reader.GetInt32(9);
                    objVoteNo.pNum5 = reader.GetInt32(10);
                    objVoteNo.pNum6 = reader.GetInt32(11);
                    objVoteNo.State = reader.GetByte(12);
                    objVoteNo.AddTime = reader.GetDateTime(13);
                    listVoteNos.Add(objVoteNo);
                }
            }
            return listVoteNos;
        }
