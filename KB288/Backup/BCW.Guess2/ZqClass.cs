...
namespace TPR2.Common.Guess
{
    ...
    public class ZqClass
    {
        ...
        /// <returns></returns>
        public static string getZqsxCase(TPR2.Model.guess.BaPay model)
        {
            string strVal = "";
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static string getZqdxCase(TPR2.Model.guess.BaPay model)
        {
            string strVal = "";
            int intone, inttwo;
            intone = Convert.ToInt32(model.p_result_one);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static string getZqbzCase(TPR2.Model.guess.BaPay model)
        {
            string strVal = "";
            int intone, inttwo;
            intone = Convert.ToInt32(model.p_result_one);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static string getZqScoreCase(TPR2.Model.guess.BaPay model)
        {
            string strVal = "";
            int intone, inttwo;
            intone = Convert.ToInt32(model.p_result_one);
            ...
            string sbf = "1" + intone + "" + inttwo;
            int bf = Convert.ToInt32(sbf);
            if (intone - inttwo >= 5)
                bf = 150;
            else if (inttwo - intone >= 5)
                bf = 151;

            //为152的时候,则为其他波胆
            if (model.PayType == 152)
            {
                //判断输赢 //不包含5球
                if (/*bf != 150 && bf != 151 &&*/ bf != 110 && bf != 101 && bf != 100 && bf != 120 && bf != 102 && bf != 111 && bf != 130 && bf != 103 && bf != 122 && bf != 140 && bf != 104 && bf != 133 && bf != 121 && bf != 112 && bf != 144 && bf != 131 && bf != 113 && bf != 141 && bf != 114 && bf != 132 && bf != 123 && bf != 142 && bf != 124 && bf != 143 && bf != 134)
                {
                    //不属于所有波胆的时候则为其他波胆
                    bf = 152;
                }
