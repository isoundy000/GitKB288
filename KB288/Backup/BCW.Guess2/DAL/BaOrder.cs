...
namespace TPR2.DAL.guess
{
	...
	public class BaOrder
	{
        ...
        public void UpdateOrder(TPR2.Model.guess.BaOrder model)
        {
            ...
            strSql.Append(" FROM tb_TBaOrder ");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(TPR2.Model.guess.BaOrder model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_TBaOrder(");
		...
		/// 更新一条数据
		/// </summary>
		public void Update(TPR2.Model.guess.BaOrder model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tb_TBaOrder set ");
        ...
        public void DeleteStr()
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_TBaOrder ");
        ...
        {
            IList<TPR2.Model.guess.BaOrder> listBaOrders = new List<TPR2.Model.guess.BaOrder>();

            string sTable = "tb_TBaOrder";
            string sPkey = "id";
