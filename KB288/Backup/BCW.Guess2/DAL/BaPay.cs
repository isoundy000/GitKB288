...
namespace TPR2.DAL.guess
{
    ...
    public class BaPay
    {
        ...
        public decimal GetBaPayMoney(int id, int payusid)
        {
            ...
            strSql.Append("SELECT p_getMoney from tb_TBaPay where ");
            strSql.Append(" id=@id ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT Count(ID) from tb_TBaPay where ");
        ...
        public int GetBaPayNum(int ibcid, int iptype)
        {
            ...
            strSql.Append("bcid=@bcid and ");
            strSql.Append("pType=@pType and ");
            strSql.Append("itypes=@itypes and Types=0 and isrobot=0");
            SqlParameter[] parameters = {
					new SqlParameter("@bcid", SqlDbType.Int,4),
					new SqlParameter("@pType", SqlDbType.Int,4),
					new SqlParameter("@itypes", SqlDbType.Int,4)};
        ...
        public int GetBaPayNum_robot(int ibcid, int iptype)
        {
            ...
            strSql.Append("bcid=@bcid and ");
            strSql.Append("pType=@pType and ");
            strSql.Append("itypes=@itypes and Types=0 and isrobot=1");
            SqlParameter[] parameters = {
                    new SqlParameter("@bcid", SqlDbType.Int,4),
                    new SqlParameter("@pType", SqlDbType.Int,4),
                    new SqlParameter("@itypes", SqlDbType.Int,4)};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT sum(payCent) from tb_TBaPay where ");
            strSql.Append("bcid=@bcid and ");
            strSql.Append("pType=@pType and ");
            strSql.Append("itypes=@itypes  and Types=0 and isrobot=0");//邵广林 20160817 会员查询0
            SqlParameter[] parameters = {
					new SqlParameter("@bcid", SqlDbType.Int,4),
					new SqlParameter("@pType", SqlDbType.Int,4),
					new SqlParameter("@itypes", SqlDbType.Int,4)};
        ...
        public long GetBaPayCent_robot(int ibcid, int iptype)
        {
            ...
            strSql.Append("bcid=@bcid and ");
            strSql.Append("pType=@pType and ");
            strSql.Append("itypes=@itypes  and Types=0 and isrobot=1");//邵广林 20160817 会员查询0
            SqlParameter[] parameters = {
                    new SqlParameter("@bcid", SqlDbType.Int,4),
                    new SqlParameter("@pType", SqlDbType.Int,4),
                    new SqlParameter("@itypes", SqlDbType.Int,4)};
        ...
        public long GetBaPayCent(int ibcid, int iptype, DateTime dt)
        {
            ...
            strSql.Append("bcid=@bcid and ");
            strSql.Append("pType=@pType and ");
            strSql.Append("itypes=@itypes  and Types=0 and paytimes>'" + dt + "'");
            SqlParameter[] parameters = {
					new SqlParameter("@bcid", SqlDbType.Int,4),
					new SqlParameter("@pType", SqlDbType.Int,4),
					new SqlParameter("@itypes", SqlDbType.Int,4)};
        ...
        public long GetBaPayCent(int ibcid, int iptype, int payusid)
        {
            ...
            strSql.Append("payusid=@payusid  and Types=0");
            SqlParameter[] parameters = {
					new SqlParameter("@bcid", SqlDbType.Int,4),
					new SqlParameter("@pType", SqlDbType.Int,4),
					new SqlParameter("@itypes", SqlDbType.Int,4),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT Count(ID) from tb_TBaPay where " + strWhere + " and itypes=0");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT sum(payCent) from tb_TBaPay where " + strWhere + " and itypes=0");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT sum(p_getMoney) from tb_TBaPay where " + strWhere + " and itypes=0");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from tb_TBaPay");
        ...
        public void UpdateIsCase(int ID)
        {
            ...
            //更新此记录得到的币
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_TBaPay set ");
        ...
        public void UpdateSure(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_TBaPay set ");
            strSql.Append("sure=@sure");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                new SqlParameter("@ID", SqlDbType.Int,4),
                new SqlParameter("@sure", SqlDbType.Int,4)};
            parameters[0].Value = ID;
            parameters[1].Value = 0;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into tb_TBaPay(");
            strSql.Append("payview,payusid,payusname,bcid,pType,PayType,payCent,payonLuone,payonLutwo,payonLuthr,p_pk,p_dx_pk,p_pn,paytimes,p_result_temp1,p_result_temp2,itypes,types,state,p_TPRtime,p_oncetime2,isrobot)");
            ...
            parameters[19].Value = model.p_TPRtime;
            parameters[20].Value = model.p_oncetime2;
            parameters[20].Value = model.p_oncetime2;

            if (!string.IsNullOrEmpty(model.isrobot.ToString()))
            {
        ...
        public void Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_TBaPay ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public decimal Getp_getMoney(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 p_getMoney from tb_TBaPay ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public int GetTypes(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Types from tb_TBaPay ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public int Getbcid(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 bcid from tb_TBaPay ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public TPR2.Model.guess.BaPay GetModelIsCase(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,payview,p_getMoney,pType,bcid,types,paycent,payusid,payusname from tb_TBaPay ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        {
            IList<TPR2.Model.guess.BaPay> listBaPays = new List<TPR2.Model.guess.BaPay>();

            string sTable = "tb_TBaPay";
            string sPkey = "id";
            string sField = "id,payview,payusid,payusname,pType,PayType,payCent,payonLuone,payonLutwo,payonLuthr,p_pk,p_dx_pk,p_pn,p_result_one,p_result_two,p_getMoney,paytimes,p_active,p_result_temp1,p_result_temp2,itypes,types,state,sure,isrobot";
            string sCondition = strWhere;
            string sOrder = "id desc";
            int iSCounts = 0;
            string queryString = "SELECT " + sField + " FROM " + sTable + " WHERE " + sCondition + " ORDER BY " + sOrder;
            string cueryString = "SELECT Count(*) FROM " + sTable + " WHERE " + sCondition;
            using (SqlDataReader reader = SqlHelper.ExecuteReader(queryString))
            {
                p_recordCount = Convert.ToInt32(SqlHelper.GetSingle(cueryString));
                if (p_recordCount > 0)
                {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        TPR2.Model.guess.BaPay objBaPay = new TPR2.Model.guess.BaPay();
                        ...
                        objBaPay.sure = reader.GetInt32(23);
                        ...
                        {
                            objBaPay.isrobot = reader.GetInt32(24);
                        }
        ...
        {
            IList<TPR2.Model.guess.BaPay> listBaPayViews = new List<TPR2.Model.guess.BaPay>();
            ...
            // 计算记录数
            string countString = "SELECT COUNT(DISTINCT payusid) FROM tb_TBaPay where " + strWhere + "";
            ...
            if (itype == 0)
            {
                queryString = "SELECT payusid,payusname,count(payusid) as payCount,sum(payCent) as payCents,isrobot FROM tb_TBaPay where " + strWhere + " group by payusid,payusname,isrobot Order by sum(payCent) desc";
            }
            else
            {
                queryString = "SELECT payusid,payusname,sum(p_getMoney) as payCount,sum(payCent) as payCents,isrobot FROM tb_TBaPay where " + strWhere + " group by payusid,payusname,isrobot Order by (sum(p_getMoney)-sum(payCent)) desc";
            }
            using (SqlDataReader reader = SqlHelper.ExecuteReader(queryString))
            {
                int stratIndex = (p_pageIndex - 1) * p_pageSize;
                ...
                while (reader.Read())
                {
                    if (k >= stratIndex && k < endIndex)
                    {
                        ...
                        objBaPay.isrobot = reader.GetInt32(4);//邵广林 20160817 增加机器人字段
        ...
        {
            IList<TPR2.Model.guess.BaPay> listBaPayTop = new List<TPR2.Model.guess.BaPay>();
            ...
            if (itype != 1)
            {
                queryString = "SELECT payusid,count(payusid) as payCount,sum(payCent) as payCents FROM tb_TBaPay where " + strWhere + " group by payusid Order by Count(ID) desc";
            }
            else
            {
                queryString = "SELECT payusid,sum(p_getMoney-payCent) as payCents FROM tb_TBaPay where " + strWhere + " group by payusid Order by sum(p_getMoney-payCent) desc";
            }
            using (SqlDataReader reader = SqlHelper.ExecuteReader(queryString))
            {
                int stratIndex = (p_pageIndex - 1) * p_pageSize;
