...
namespace TPR2.Collec
{
    public class GetLiveover
    {
        ...
        ///// 取得篮球完场比分
        ///// </summary>
        //public IList<TPR2.Model.guess.BaList> Getbasketover(string Times, out int p_recordCount)
        //{
        ...
        /// 取得篮球完场比分(搜索)
        /// </summary>
        public IList<TPR2.Model.guess.BaList> Getbasketover(string p_one, out int p_recordCount)
        {
            IList<TPR2.Model.guess.BaList> objbasket = new List<TPR2.Model.guess.BaList>();
            p_recordCount = 0;
        ...
        /// 取得足球完场比分
        /// </summary>
        public IList<TPR2.Model.guess.BaList> Getfootover(string Times, out int p_recordCount)
        {
