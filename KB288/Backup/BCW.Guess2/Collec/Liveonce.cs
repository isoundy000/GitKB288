...
namespace TPR2.Collec
{
    ...
    public class Once
    {
        ...
        //http://61.143.225.107/vbsxml/change2.xml足球滚球，如限制了IP请用域名live6.titan007.com
        /// <summary>
        /// 取得即时足球比分XML
        /// </summary>
        public IList<TPR2.Model.guess.BaList> GetOnce(out int p_recordCount)
        {
        ...
        /// 取得即时篮球比分XML
        /// </summary>
        public IList<TPR2.Model.guess.BaList> GetOnce1(out int p_recordCount)
        {
            IList<TPR2.Model.guess.BaList> obj = new List<TPR2.Model.guess.BaList>();
            p_recordCount = 0;
        ...
        private IList<TPR2.Model.guess.BaList> OnceHtml(string p_html, out int p_recordCount)
        {
        ...
        /// 取得足球滚球XML(取进球的分钟数集合)
        /// </summary>
        public IList<TPR2.Model.guess.BaList> GetOnce2(int ID)
        {
            IList<TPR2.Model.guess.BaList> obj = new List<TPR2.Model.guess.BaList>();
            ...
            httpRequest.Fc.CacheTime = this._CacheTime;
            httpRequest.Fc.CacheFolder = this._CacheFolder;
            httpRequest.Fc.CacheFile = "滚球XML" + ID + "";
