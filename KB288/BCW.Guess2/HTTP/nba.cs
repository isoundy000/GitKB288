...
namespace TPR2.Http
{
    ...
    public class GetNbaword
    {
        ...
        /// 取得Nba文字直播列表
        /// </summary>
        public TPR2.Model.Http.Nba Getnbalist()
        {
            TPR2.Model.Http.Nba objnbalist = null;
        ...
        private TPR2.Model.Http.Nba LivenbalistHtml(string p_html)
        {
            string strVal = p_html;
            TPR2.Model.Http.Nba objnbalist = new TPR2.Model.Http.Nba();
        ...
        /// 取得Nba文字直播页面
        /// </summary>
        public TPR2.Model.Http.Nba Getnbapage(int nbaid)
        {
            TPR2.Model.Http.Nba objnbapage = null;
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR2.Model.Http.Nba LivenbapageHtml(string p_html)
        {
            string strVal = p_html;
            TPR2.Model.Http.Nba objnbapage = new TPR2.Model.Http.Nba();
        ...
        /// 取得Nba文字直播内容
        /// </summary>
        public TPR2.Model.Http.Nba Getnbaview(int nbaid, int pn)
        {
            TPR2.Model.Http.Nba objnbaview = null;
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR2.Model.Http.Nba LivenbaviewHtml(string p_html)
        {
            string strVal = p_html;
            TPR2.Model.Http.Nba objnbaview = new TPR2.Model.Http.Nba();
