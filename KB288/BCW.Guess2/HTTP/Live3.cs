...
namespace TPR2.Http
{
    ...
    public class GetLive3
    {
        ...
        /// 取得篮球即时比分列表
        /// </summary>
        public TPR2.Model.Http.Live3 Getllist(string p_title)
        {
            TPR2.Model.Http.Live3 objllist = null;
        ...
        private TPR2.Model.Http.Live3 Live3llistHtml(string p_html)
        {
            string strVal = p_html;
            TPR2.Model.Http.Live3 objllist = new TPR2.Model.Http.Live3();
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR2.Model.Http.Live3 Live3tlistHtml(string p_html)
        {
            string strVal = p_html;
            TPR2.Model.Http.Live3 objtlist = new TPR2.Model.Http.Live3();
        ...
        /// </summary>
        /// <param name="p_html">HTML文档</param>
        private TPR2.Model.Http.Live3 Live3vlistHtml(string p_html)
        {
            string strVal = p_html;
            TPR2.Model.Http.Live3 objvlist = new TPR2.Model.Http.Live3();
