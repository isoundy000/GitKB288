...
namespace TPR2.DAL.guess
{
    ...
    public class Super
    {
        ...
        public int GetMaxId()
        {
            return SqlHelper.GetMaxID("ID", "tb_TSuper");
        }
        ...
        public bool Exists(int ID, int UsID)
        {
            ...
            strSql.Append("select count(1) from tb_TSuper");
        ...
        public void UpdateIsCase(int ID)
        {
            ...
            //更新此记录得到的币
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_TSuper set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT Count(ID) from tb_TSuper where " + strWhere + "");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT sum(payCent) from tb_TSuper where " + strWhere + "");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT sum(getMoney) from tb_TSuper where " + strWhere + "");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into tb_TSuper(");
        ...
        public void Update3(TPR2.Model.guess.Super model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@PayCent", SqlDbType.Money,8),
					new SqlParameter("@IsOpen", SqlDbType.Int,4),
					new SqlParameter("@p_isfs", SqlDbType.Int,4),
					new SqlParameter("@AddTime", SqlDbType.DateTime)};
            parameters[0].Value = model.ID;
            parameters[1].Value = model.PayCent;
            parameters[2].Value = model.IsOpen;
            parameters[3].Value = model.p_isfs;
        ...
        public void Update4(TPR2.Model.guess.Super model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@getOdds", SqlDbType.NVarChar,1000)};
            parameters[0].Value = model.ID;
        ...
        public void Update6(TPR2.Model.guess.Super model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_TSuper set ");
            strSql.Append("p_Auto=@p_Auto ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4),
                    new SqlParameter("@p_Auto", SqlDbType.Int,4)};
            parameters[0].Value = model.ID;
            parameters[1].Value = model.p_Auto;
        ...
        public void Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_TSuper ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public int GetSuperID(int UsID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID from tb_TSuper ");
        ...
        public string GetSuperBID(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 BID from tb_TSuper ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public decimal GetgetMoney(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 getMoney from tb_TSuper ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        public TPR2.Model.guess.Super GetSuper(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,UsID,BID,SP,Title,Times,StTitle,Odds,PayCent,Status,IsOpen,getMoney,getOdds,AddTime,PID,p_isfs,UsName,p_Auto from tb_TSuper ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(strSql.ToString(), parameters))
            {
                if (reader.HasRows)
                {
                    ...
                    model.p_isfs = reader.GetInt32(15);
                    model.UsName = reader.GetString(16);
                    model.p_Auto = reader.GetInt32(17);
                    return model;
                }
                else
                {
        ...
        {
            IList<TPR2.Model.guess.Super> listSupers = new List<TPR2.Model.guess.Super>();
            string sTable = "tb_TSuper";
            string sPkey = "id";
            string sField = "ID,Title,PayCent,Status,p_case,getMoney,UsID,p_isfs,AddTime,getMoney,p_Auto";
            ...
            using (SqlDataReader reader = SqlHelper.RunProcedureMe(sTable, sPkey, sField, p_pageIndex, p_pageSize, sCondition, sOrder, iSCounts, out p_recordCount))
            {
                ...
                while (reader.Read())
                {
                    TPR2.Model.guess.Super objSuper = new TPR2.Model.guess.Super();
                    ...
                    objSuper.p_isfs = reader.GetInt32(7);
                    objSuper.AddTime = reader.GetDateTime(8);
                    objSuper.getMoney = reader.GetDecimal(9);
                    objSuper.p_Auto = reader.GetInt32(10);
