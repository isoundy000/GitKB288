...
namespace BCW.XinKuai3.DAL
{
    ...
    public class XK3_Bet
    {
        ...
        public int GetMaxId()
        {
            return SqlHelper.GetMaxID("ID", "tb_XK3_Bet");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from tb_XK3_Bet");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(BCW.XinKuai3.Model.XK3_Bet model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into tb_XK3_Bet(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_XK3_Bet set ");
        ...
        public void Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_XK3_Bet ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        /// me_得到一个对象实体
        /// </summary>
        public BCW.XinKuai3.Model.XK3_Bet GetXK3_Bet(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,UsID,Play_Way,Sum,Three_Same_All,Three_Same_Single,Three_Same_Not,Three_Continue_All,Two_Same_All,Two_Same_Single,Two_dissame,Input_Time,DanTuo,Zhu,GetMoney,PutGold,State,Lottery_issue,Zhu_money,DaXiao,DanShuang from tb_XK3_Bet ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;

            BCW.XinKuai3.Model.XK3_Bet model = new BCW.XinKuai3.Model.XK3_Bet();
        ...
        /// </summary>
        public BCW.XinKuai3.Model.XK3_Bet GetXK3_Bet_num(string Lottery_issue)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  * from tb_XK3_Bet ");
            strSql.Append(" where Lottery_issue=@Lottery_issue ");
            SqlParameter[] parameters = {
                    new SqlParameter("@Lottery_issue", SqlDbType.VarChar,20)};
            parameters[0].Value = Lottery_issue;
        ...
        public void UpdateExceed_num(string _where)
        {
            ...
            strSql.Append("UPDATE tb_XK3_Bet SET state=3");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT Sum(" + ziduan + ") from tb_XK3_Bet");
        ...
        /// me_根据所点的历史记录，通过开奖期号查询相应的投注情况
        /// </summary>
        public BCW.XinKuai3.Model.XK3_Bet GetXK3_Bet_hounum(string Lottery_issue)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  COUNT(*) as aa from tb_XK3_Bet ");
            strSql.Append(" where Lottery_issue=@Lottery_issue ");
            SqlParameter[] parameters = {
                    new SqlParameter("@Lottery_issue", SqlDbType.VarChar,20)};
            parameters[0].Value = Lottery_issue;
        ...
        //me_查询机器人购买次数
        public int GetXK3_Bet_GetRecordCount(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM tb_XK3_Bet ");
            if (strWhere.Trim() != "")
        ...
        public IList<BCW.XinKuai3.Model.XK3_Bet> GetXK3_Bet_playnum1(int p_pageIndex, int p_pageSize, string strWhere, out int p_recordCount)
        {
            IList<BCW.XinKuai3.Model.XK3_Bet> listXK3_Bets = new List<BCW.XinKuai3.Model.XK3_Bet>();
            string sTable = "tb_XK3_Bet";
            string sPkey = "";
            ...
            using (SqlDataReader reader = SqlHelper.RunProcedureMe(sTable, sPkey, sField, p_pageIndex, p_pageSize, sCondition, sOrder, iSCounts, out p_recordCount))
            {
                ...
                while (reader.Read())
                {
                    BCW.XinKuai3.Model.XK3_Bet objXK3_Bet = new BCW.XinKuai3.Model.XK3_Bet();
                    objXK3_Bet.UsID = reader.GetInt32(0);
                    objXK3_Bet.bb = reader.GetInt64(1);
                    listXK3_Bets.Add(objXK3_Bet);
                }
            }
            return listXK3_Bets;
        }
        //me_取得每个玩家投注的记录进行排序22
        public IList<BCW.XinKuai3.Model.XK3_Bet> GetXK3_Bet_playnum2(int p_pageIndex, int p_pageSize, string strWhere, out int p_recordCount)
        {
            IList<BCW.XinKuai3.Model.XK3_Bet> listXK3_Bets = new List<BCW.XinKuai3.Model.XK3_Bet>();
            string sTable = "tb_XK3_Bet";
            string sPkey = "";
        ...
        public IList<BCW.XinKuai3.Model.XK3_Bet> GetXK3_Bet_playnum3(int p_pageIndex, int p_pageSize, string strWhere, out int p_recordCount)
        {
            IList<BCW.XinKuai3.Model.XK3_Bet> listXK3_Bets = new List<BCW.XinKuai3.Model.XK3_Bet>();
            string sTable = "tb_XK3_Bet";
            string sPkey = "";
            ...
            using (SqlDataReader reader = SqlHelper.RunProcedureMe(sTable, sPkey, sField, p_pageIndex, p_pageSize, sCondition, sOrder, iSCounts, out p_recordCount))
            {
                ...
                while (reader.Read())
                {
                    BCW.XinKuai3.Model.XK3_Bet objXK3_Bet = new BCW.XinKuai3.Model.XK3_Bet();
                    objXK3_Bet.UsID = reader.GetInt32(0);
                    objXK3_Bet.bb = reader.GetInt32(1);
                    listXK3_Bets.Add(objXK3_Bet);
                }
            }
            return listXK3_Bets;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  " + s1 + " from tb_XK3_Bet " + s2 + " ");
        ...
        /// <returns>IList XK3_Bet</returns>
        public IList<BCW.XinKuai3.Model.XK3_Bet> GetXK3_Bets(int p_pageIndex, int p_pageSize, string strWhere, out int p_recordCount)
        {
            IList<BCW.XinKuai3.Model.XK3_Bet> listXK3_Bets = new List<BCW.XinKuai3.Model.XK3_Bet>();
            string sTable = "tb_XK3_Bet";
            string sPkey = "id";
            ...
            using (SqlDataReader reader = SqlHelper.RunProcedureMe(sTable, sPkey, sField, p_pageIndex, p_pageSize, sCondition, sOrder, iSCounts, out p_recordCount))
            {
                ...
                {
                    BCW.XinKuai3.Model.XK3_Bet objXK3_Bet = new BCW.XinKuai3.Model.XK3_Bet();
                    objXK3_Bet.ID = reader.GetInt32(0);
                    objXK3_Bet.UsID = reader.GetInt32(1);
                    objXK3_Bet.Play_Way = reader.GetInt32(2);
                    objXK3_Bet.Sum = reader.GetString(3);
                    objXK3_Bet.Three_Same_All = reader.GetString(4);
                    objXK3_Bet.Three_Same_Single = reader.GetString(5);
                    objXK3_Bet.Three_Same_Not = reader.GetString(6);
                    objXK3_Bet.Three_Continue_All = reader.GetString(7);
                    objXK3_Bet.Two_Same_All = reader.GetString(8);
                    objXK3_Bet.Two_Same_Single = reader.GetString(9);
                    objXK3_Bet.Two_dissame = reader.GetString(10);
                    objXK3_Bet.Input_Time = reader.GetDateTime(11);
                    objXK3_Bet.DanTuo = reader.GetString(12);
                    objXK3_Bet.Zhu = reader.GetInt32(13);
                    objXK3_Bet.GetMoney = reader.GetInt64(14);
                    objXK3_Bet.PutGold = reader.GetInt64(15);
                    objXK3_Bet.State = reader.GetInt32(16);
                    objXK3_Bet.Lottery_issue = reader.GetString(17);
                    objXK3_Bet.Zhu_money = reader.GetInt64(18);
                    objXK3_Bet.DaXiao = reader.GetString(19);
                    objXK3_Bet.DanShuang = reader.GetString(20);
                    //objXK3_Bet.Odds = reader.GetDecimal(21);
                    listXK3_Bets.Add(objXK3_Bet);
                }
            }
            return listXK3_Bets;
